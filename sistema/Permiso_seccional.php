                        ...
                        <div class="wizard-container">
                            ...
                            <!--        You can switch " data-color="purple" "  with one of the next bright colors: "green", "orange", "red", "blue"       -->
                                    <div class="wizard-header">
                                        ...
                                        <h5>Permisos para sindicalistas, se necesita comprobante.</h5>
                                    </div>
                                    <!-- html -->
                                    <div id="contenidoCambiante" class="tab-content" style="margin-top:0px;">
                                      <div class="material-datatables">
                                                  ...
                                                  get_Row_Empleados_permiso_seccional();
                                                  ?>
        					                            </tbody>
        					                        </table>
        					                    </div>
                                    ...
                                    <div class="wizard-footer">
                                        ...
                                        <div class="pull-left">
                                          <input type='button' class='btn btn-previous btn-fill btn-primary btn-wd' id='previousPermisoS'name='previousPermisoS' value='Inicio' />
                                        </div>
																				<?php
