	            ...
	            <div class="container-fluid">
					        ...
					        <div class="col-md-8">
					            <div class="card">
					                ...
					                <div class="card-content">
					                    <h4 class="card-title">Suspension por Empleados</h4>
					                    <div class="toolbar">
                  ...
                  <!--  Otra tabla  -->
                    <div class="col-md-4">
					                ...
					                <div class="card-content">
					                    <h4 class="card-title">Reporte Suspension</h4>
					                    <div class="toolbar">
					                        <!--        Here you can write extra buttons/actions for the toolbar              -->
					                    </div>
					                    <div class="row">
                                  ...
                                  <div class="col-md-8">
                                    <div class="form-group">
                                      ...
                                      <div class='input-group date'>
                                        <?php
                                          echo "<input type='text' class='form-control' placeholder=".date("d")."/".date("m")."/".date("Y")." name='date' id='FechaIni' data-select='datepicker'/>";
                                        ?>
                                      </div>
                                  </div>
                                </div>
                                <div class="col-md-8">
                                  <div class="form-group">
                                    ...
                                    <div class='input-group date'>
                                      <?php
                                        echo "<input type='text' class='form-control' placeholder=".date("d")."/".date("m")."/".date("Y")." name='date' id='FechaFin' data-select='datepicker'/>";
                                      ?>
                                    </div>
                                </div>
                              </div>
                            ...
                            <form method="POST"  action="PDF_Reporte_Suspension.php" id="PDFUserForm">
